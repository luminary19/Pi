...
try {
    ...
    Invoke-Native npm --workspace "@earendil-works/pi-coding-agent" test -- --run test/suite/regressions/6363-agent-settled-event.test.ts test/interactive-mode-status.test.ts test/bash-close-hang-windows.test.ts test/package-command-paths.test.ts
